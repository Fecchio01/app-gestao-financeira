    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="glass-panel p-8 max-w-md w-full animate-slide-up relative overflow-hidden">
        ...
        <div className="text-center mb-6">
          <div className="flex justify-center mb-4 animate-float text-brand-400">
        ...
        <div className="space-y-5">
          <div className="group">
            <label className="block text-sm text-gray-400 mb-1 flex items-center gap-2">
              <Wallet size={16} className="text-brand-400" /> Banca Atual / Guardado
            </label>
          ...
          <div className="group">
            <label className="block text-sm text-gray-400 mb-1 flex items-center gap-2">
              <Briefcase size={16} className="text-brand-400" /> Renda Fixa Mensal
            </label>
          ...
          <div className="group">
            <label className="block text-sm text-gray-400 mb-1 flex items-center gap-2">
              <Target size={16} className="text-brand-400" /> Meta Anual
            </label>
